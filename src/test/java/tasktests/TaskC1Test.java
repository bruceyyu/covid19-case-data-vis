...
public class TaskC1Test extends ApplicationTest {
    ...
    public void testValidDate() {
        ...
        Node lookUpRoot = tabPane.getTabs().get(3).getContent();


        DatePicker datePicker = from(lookUpRoot).lookup("#datePicker").query();
        datePicker.setValue(LocalDate.of(2021, 5, 12));
        ...
        BigInteger vaccinated =  (BigInteger) column1.getCellObservableValue(0).getValue();
        assertEquals(BigInteger.valueOf(55624), vaccinated);
