...
public class TaskB1Test extends ApplicationTest {
    ...
    public void testValidDate() {
        ...
        Node lookUpRoot = tabPane.getTabs().get(2).getContent();
        ...
        BigInteger deaths =  (BigInteger) column1.getCellObservableValue(0).getValue();
        assertEquals(BigInteger.valueOf(2698), deaths);
        assertEquals(BigInteger.valueOf(124745), column1.getCellObservableValue(1).getValue());
