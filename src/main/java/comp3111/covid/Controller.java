...
public class Controller {
    ...
    @FXML
    private ListView tableACountryList;
    ...
    Date dd = new Date(2021, 1,1);
    ObservableList<DailyStatistics> list = FXCollections.observableArrayList(
        new DailyStatistics("chi", dd, 1.0, 1, 1.0, 1, 1.0, 1),
        new DailyStatistics("chi", dd, 1.0, 1, 1.0, 1, 1.0, 1)
    );
    @FXML
